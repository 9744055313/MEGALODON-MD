...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~sUREUR7b#_HOeiOWN5WMJqWZXzjtnKobbn5JJyuUK0JTOljIeKJk",  // Your bot's session ID (keep it secure)
    
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    
    BOT_NAME: process.env.BOT_NAME || getConfig("black killar") || "black killar",  // Bot's display name
    
    MODE: process.env.MODE || "public",        // Bot mode: public/private/group/inbox

    // ===== OWNER & DEVELOPER SETTINGS =====
    OWNER_NUMBER: process.env.OWNER_NUMBER || "919961842024",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "black killar",           // Owner's name
    
    DEV: process.env.DEV || "919961842024",                     // Developer's contact number
